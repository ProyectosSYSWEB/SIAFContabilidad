                        ...
                        <asp:MultiView ID="MultiView1" runat="server">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlCentros_Contables0" runat="server" AutoPostBack="True" Width="95%">
                                                                </asp:DropDownList>
                                                                <br />
                            ...
                            <asp:View ID="View2" runat="server">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" colspan="2" style="width: 70%" width="55%">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlCentros_Contables" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCentros_Contables_SelectedIndexChanged" Width="95%">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    ...
                                    <tr>
                                        <td width="15%" class="izquierda">&nbsp;</td>
                                        <td width="55%">&nbsp;</td>
                                        <td width="15%">&nbsp;</td>
                                    </tr>
                                    <tr>
